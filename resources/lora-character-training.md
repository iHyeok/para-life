...
### 로라는 베이스 모델로 작성
- 링크: https://arca.live/b/aiart/167339651/880354373
- 요약: LoRA는 베이스 모델 기준으로 학습해야 하는 이유와 방법

### 시리즈 베이스로 학습
- 링크: https://arca.live/b/hypernetworks/166473254
- 요약: 시리즈(작품) 단위를 베이스로 삼아 캐릭터 LoRA를 학습하는 접근법
